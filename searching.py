...
print soup.find_all('p') #gives all <p> tag
print soup.find_all('a') #gives all anchor / <a> tag
print soup.find_all("a", id = 'link2') #gives links of given id
for tag in soup.find_all(re.compile("^b")):
	print tag.name #give all word/name starting with letter b 
